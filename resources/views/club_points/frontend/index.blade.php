...
@section('content')
    @php
        $club_point_convert_rate = \App\Models\BusinessSetting::where('type', 'club_point_convert_rate')->first()->value;
                    $amount     = \App\Models\ClubPoint::where('user_id',Auth::id())->sum('points');
    @endphp
    <section class="py-5">
        <div class="container">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-7 mx-auto">
                            <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                                <div class="px-3 pt-3 pb-3">
                                  @if($amount >= 50)
                                    <div class="h1 fw-700 text-center">PLATINUM USER</div>
                                     @elseif($amount >= 30)
                                      <div class="h1 fw-700 text-center">DIAMOND  USER</div>
                                      @else
                                       <div class="h1 fw-700 text-center">GOLD USER</div>
                                       @endif
