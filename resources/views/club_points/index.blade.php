                        ...
                        <tbody>
                            @foreach($club_points as $key => $club_point)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                        $amount     = \App\Models\ClubPoint::where('user_id',$club_point->user->id)->sum('points');
                                       
                                        @endphp 
                                       
                                    @if($amount >= 50)
                                         <h4 style="color:#D7D7D7">PLATINUM  </h4> 
                                     @elseif($amount >= 30)
                                           <h4 style="color:#D7D7D7"> DIAMOND</h4> 
                                     
                                      @else
                                      <h4 style="color:#E8A623;">GOLD</h4>
                                       @endif
