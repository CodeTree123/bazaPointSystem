                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('generation.transaction') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Generation transaction History') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <!-- Support -->
                ...
                <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('User Generation Setting')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <!--<li class="aiz-side-nav-item">-->
                            ...
                            <!--</li>-->
                            <li class="aiz-side-nav-item">
                                <a href="{{route('generation.setting')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Level Information')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('commission.list')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Commission List')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
