...
class BkashController extends Controller
{
    ...
    public function getRefund(Request $request){
        return view('backend.sales.all_orders.refund');
    ...
    public function refund(Request $request)
    {
        try {
            ...
            $result_data_array = json_decode($resultdata,true);
            return View('backend.sales.all_orders.refund')->with('result_data_array', $result_data_array);
        }catch(Exception $e){
            return View('backend.sales.all_orders.refund')->with('errorMessage', "Something Went Wrong !!");
