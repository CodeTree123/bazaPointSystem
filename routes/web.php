...
Route::get('/users/register/{reference?}', 'HomeController@referralRegistrationView')->name('user.register.reference');
Route::post('/users/referral/register/post', 'HomeController@referralRegistrationPost')->name('user.register.referral');
...
//bKash
    ...
    Route::post('/bkash/create', 'BkashController@checkout')->name('bkash.checkout');
