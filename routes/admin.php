...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/bkash/refund', 'BkashController@getRefund')->name('get.refund');
    ...
    Route::get('/level/information', 'AdminController@levelInformation')->name('generation.setting');
    Route::get('/commission/list', 'AdminController@commissionList')->name('commission.list');
    Route::get('/generation/transaction', 'AdminController@generationTransaction')->name('generation.transaction');
    Route::get('/level/delete', 'AdminController@refDelete')->name('generation.delete');
    Route::get('/level/edit/{id}', 'AdminController@refEdit')->name('generation.edit');
    Route::post('/level/set', 'AdminController@levelSet')->name('generation.set');
    Route::post('/level/update', 'AdminController@levelUpdate')->name('generation.update');
});
